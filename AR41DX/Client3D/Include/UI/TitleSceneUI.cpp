...
void CTitleSceneUI::CreateBackgroundUI()
{
	...
	Image->SetTexture("UIBackground", TEXT("Title/SB_BfBB-TITLESCREEN-FULL.tga"));
	...
	Image->SetTexture("UIBackBoard", TEXT("Title/Startscreen_map.tga"));
	...
	Image->SetTexture("UILogo", TEXT("Title/Logo/Logo_SBSP_BB_02.tga"));
	...
	Image->SetTexture("UISmallLogo", TEXT("Title/Logo/Korean_logo.tga"));
	...
	Image->SetTexture("FlowersLeft", TEXT("Title/Startscreen_flowers_left.tga"));
	...
	Image->SetTexture("FlowersRight", TEXT("Title/Startscreen_flowers_right.tga"));
...
void CTitleSceneUI::CreateMainUI()
{
	...
	TextButton->SetText(EButtonState::Normal, TEXT("계속"), FontSize, Vector4::Black);
	TextButton->SetText(EButtonState::Hovered, TEXT("계속"), FontSize, Vector4::Black);
	TextButton->SetText(EButtonState::Click, TEXT("계속"), FontSize, Vector4::Black);
	...
	TextButton->SetText(EButtonState::Normal, TEXT("새 게임"), FontSize, Vector4::Black);
	TextButton->SetText(EButtonState::Hovered, TEXT("새 게임"), FontSize, Vector4::Black);
	TextButton->SetText(EButtonState::Click, TEXT("새 게임"), FontSize, Vector4::Black);
	...
	TextButton->SetText(EButtonState::Normal, TEXT("옵션"), FontSize, Vector4::Black);
	TextButton->SetText(EButtonState::Hovered, TEXT("옵션"), FontSize, Vector4::Black);
	TextButton->SetText(EButtonState::Click, TEXT("옵션"), FontSize, Vector4::Black);
	...
	TextButton->SetText(EButtonState::Normal, TEXT("제작진"), FontSize, Vector4::Black);
	TextButton->SetText(EButtonState::Hovered, TEXT("제작진"), FontSize, Vector4::Black);
	TextButton->SetText(EButtonState::Click, TEXT("제작진"), FontSize, Vector4::Black);
	...
	Image->SetTexture("KeyGuideMouseLeft", TEXT("Title/Key/Mouse_Left.tga"));
...
void CTitleSceneUI::CreateOptionUI()
{
	...
	TextButton->SetText(EButtonState::Normal, TEXT("오디오 설정"), FontSize, Vector4::Black);
	TextButton->SetText(EButtonState::Hovered, TEXT("오디오 설정"), FontSize, Vector4::Black);
	TextButton->SetText(EButtonState::Click, TEXT("오디오 설정"), FontSize, Vector4::Black);
	...
	Image->SetTexture("KeyGuideMouseRight", TEXT("Title/Key/Mouse_Right.tga"));
...
void CTitleSceneUI::CreateOptionSoundUI()
{
	...
	Image->SetTexture("SlideBar", TEXT("Title/Option/BarBack.png"));
	...
	Image->SetTexture("SliderCursor", TEXT("Title/Option/slider_bar.tga"));
