...
Texture2DMS<float4> g_ShadowMapTex : register(t21);
...
PS_OUTPUT_LIGHTACC CelShaderAccPS(VS_OUTPUT_LIGHTACC input)
{
    ...
    LightResult result = ComputeCelShaderLight(ViewPos, ViewNormal, GBuffer3Color.b, input.InstanceID, GBuffer4Color);
