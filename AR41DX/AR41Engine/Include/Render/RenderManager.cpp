...
{
	// cart원본을 ms로, ms 원본을 fxaa로 fxaa원본을 디퍼드로.
...
void CRenderManager::CreateRenderTarget()
{
	...
	CResourceManager::GetInst()->CreateTargetNoMS("RenderCartoon", RS.Width, RS.Height, DXGI_FORMAT_R32G32B32A32_FLOAT);
