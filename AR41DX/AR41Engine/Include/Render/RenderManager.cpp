...
void CRenderManager::RenderDeferred(float DeltaTime)
{
	...
	m_ScreenBuffer->SetTargetShader(10); // FXAA 쉐이더로 넘겨준다. 
...
void CRenderManager::CreateRenderTarget()
{
	...
	m_FXAABuffer->SetPos(Vector3(400.f, 0.f, 0.f));
	m_FXAABuffer->SetScale(Vector3(100.f, 200.f, 1.f));
